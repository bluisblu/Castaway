/*
    ...
    Language: C++
    Code range: 0x800195C8 -> 0x800195EC
*/
// Range: 0x800195C8 -> 0x800195D0
unsigned char ESim::GetIsModelLoaded() {}

// Range: 0x800195D0 -> 0x800195D8
class EIStaticModel * ESim::GetShadow() {}

// Range: 0x800195D8 -> 0x800195E4
void ESim::UpdateSimModel() {}

// Range: 0x800195E4 -> 0x800195EC
...
// Range: 0x8022305C -> 0x80223068
class ETypeInfo * ESim::GetTypeInfo() {
    // References
    // -> class ETypeInfo m_typeInfo;
}

// Range: 0x80223068 -> 0x80223078
char * ESim::GetTypeName() {
    // References
    // -> class ETypeInfo m_typeInfo;
}

// Range: 0x80223078 -> 0x80223088
unsigned int ESim::GetTypeKey() {
    // References
    // -> class ETypeInfo m_typeInfo;
}

// Range: 0x80223088 -> 0x80223098
unsigned short ESim::GetTypeVersion() {
    // References
    // -> class ETypeInfo m_typeInfo;
}

// Range: 0x80223098 -> 0x8022309C
void ESim::SetXOb() {}

// Range: 0x8022309C -> 0x802230D0
class ETypeInfo * ESim::RegisterType() {
    // References
    // -> class ETypeInfo m_typeInfo;
    // -> class ETypeInfo m_typeInfo;
}

// Range: 0x802230D0 -> 0x802230D8
void ESim::Destruct() {}

// Range: 0x802230D8 -> 0x8022310C
void ESim::Construct() {}
