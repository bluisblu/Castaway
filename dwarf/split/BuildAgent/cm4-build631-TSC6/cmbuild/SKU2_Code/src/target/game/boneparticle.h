/*
    ...
    Language: C++
    Code range: 0x800198C8 -> 0x80019920
*/
// Range: 0x800198C8 -> 0x800198D0
...
// Range: 0x802062B4 -> 0x802062CC
enum AttachmentEffectType AnimParticleData::GetEffectType() {
    // References
