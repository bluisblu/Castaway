/*
    Compile unit: C:\BuildAgent\cm4-build631-TSC6\cmbuild\SKU2_Code\src\common\EASTL\1.03.00\include\EASTL\intrusive_list.h
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80122974 -> 0x80122A3C
*/
// Range: 0x80122974 -> 0x80122988
unsigned char intrusive_list_base::empty() {}

// Range: 0x80122988 -> 0x8012299C
void intrusive_list::remove() {
    // Local variables
    struct intrusive_list_node & prev; // r4
    struct intrusive_list_node & next; // r3
}
