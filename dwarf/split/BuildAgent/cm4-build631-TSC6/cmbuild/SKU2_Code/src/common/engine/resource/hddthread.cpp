/*
    Compile unit: C:\BuildAgent\cm4-build631-TSC6\cmbuild\SKU2_Code\src\common\engine\resource\hddthread.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802EA09C -> 0x802EA24C
*/
// Range: 0x802EA09C -> 0x802EA0A0
void HDDThread::Main() {}
